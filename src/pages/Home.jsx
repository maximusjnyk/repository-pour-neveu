          ...
          <Col lg='6' md='6'>
            <div className="hero__content">
              ...
              <h1 className='mb-4 hero__title'>
                <span>Russia?</span> Just wait <br/> food at<span>your door</span>
              </h1>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui
                magni delectus tenetur autem, sint veritatis!
              </p>
              <div className="hero__btn d-flex align-content-center gap-5 mt-4">
              ...
              <div className='hero__service d-flex align-content-center gap-5 mt-5'>
                <p className='d-flex align-content-center gap-2'><span className='shipping__icon'>
        ...
        <Row>
          <Col lg='12' className='text-center'>
            ...
            <p className='mb-1 mt-4 feature__text'>
              Lorem, ipsum dolor sit amet consectetur adisipicing edit. Dolor, officiis?
            </p>
            <p className='feature__text'>
              Lorem, ipsum dolor sit amet consectetur adisipicing elit. Aperiam, eius.{ " " }
            </p>
          </Col>
          {
        ...
        <Row>
          ...
          <Col lg='6' md='6'>
            <div className="why__tasty-treat">
              ...
              <p className='teasty__treat-desc'>
